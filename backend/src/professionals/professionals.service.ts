...
export class ProfessionalsService {
  ...
  async createProfessional(createProfessionalDto: CreateProfessionalDto) {
    return this.professionalsRepository.createProfessional(
  ...
  async updateProfessional(
    ...
    return this.professionalsRepository.updateProfessional(
      id,
  ...
  async associateService(professionalId: string, serviceId: string) {
    return this.professionalsRepository.associateService(
      professionalId,
      serviceId,
    );
  }
  ...
  async getServicesByProfessional(professionalId: string) {
    return this.professionalsRepository.getServicesByProfessional(
      professionalId,
    );
  }
  ...
  async removeServiceFromProfessional(
    ...
    return this.professionalsRepository.removeServiceFromProfessional(
      professionalId,
      serviceId,
    );
  }
